...
export default function SubSectionModal({
  ...
  const onSubmit = async (data) => {
    console.log(data)
    console.log(data.lectureVideo, "video");
    if (view) return;
  ...
  return (
    <div className="fixed inset-0 z-[1000] !mt-0 grid h-screen w-screen place-items-center overflow-auto bg-white bg-opacity-10 backdrop-blur-sm text-black">
